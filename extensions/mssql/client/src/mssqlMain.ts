...
// 	export const type: RequestType<string, string, any, any> = { get method() { return 'vscode/content'; } };
// }
...
export function activate(context: ExtensionContext) {
	...
	languages.getLanguages().then(languageIds => {
		...
		let serverModule = context.asAbsolutePath(path.join('server', 'out', 'mssqlServerMain.js'));
