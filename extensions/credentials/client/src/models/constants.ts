...
export class Constants implements IExtensionConstants {
    ...
    public readonly outputChannelName = 'Credentials';
    ...
    public readonly serviceInstallingTo = 'Installing credentials service to';
    public readonly serviceInitializing = 'Initializing SQL tools service for the credentials extension.';
    ...
    public readonly serviceInstalled = 'Credentials Service installed';
    public readonly serviceInstallationFailed = 'Failed to install Credentials Service';
    public readonly serviceLoadingFailed = 'Failed to load Credentials Service';
    public readonly unsupportedPlatformErrorMessage = 'The platform is not supported';
    public readonly invalidServiceFilePath = 'Invalid file path for Credentials Service';
    ...
    public readonly serviceName = 'Credentials Service';
    public readonly serviceInitializingOutputChannelName = 'Credentials Service Initialization';
    public readonly serviceCrashMessage = 'Credentials component could not start.';
    public readonly serviceCrashLink = 'https://github.com/Microsoft/vscode-mssql/wiki/SqlToolsService-Known-Issues';
    public readonly providerId = 'credentials';
    public readonly installFolderName = 'credentials';
