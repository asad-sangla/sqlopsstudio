...
export class Constants implements IExtensionConstants {
    ...
    public readonly extensionName = 'pgsql';
    public readonly extensionConfigSectionName = 'pgsql';
    public readonly connectionApplicationName = 'vscode-pgsql';
    public readonly outputChannelName = 'PGSQL';
    public readonly providerId = 'PGSQL';
    public readonly connectionConfigFilename = 'settings.json';
    public readonly connectionsArrayName = 'pgsql.connections';
    ...
    public readonly configEnabled = 'enabled';
    public readonly configDebugSourcePath = 'debugSourcePath';
    public readonly configStartupDebugging = 'enableStartupDebugging';
    ...
    public readonly msgOpenSqlFile = 'To use this command, Open a .sql file -or- ' +
                            ...
                            'Select SQL text in the active SQL editor.';
    ...
    public readonly serviceCompatibleVersion = '0';
    public readonly serviceInstallingTo = 'Installing PgSQL tools service to';
    public readonly serviceInitializing = 'Initializing PgSQL tools service for the pgsql extension.';
    public readonly commandsNotAvailableWhileInstallingTheService = 'Note: pgsql commands will be available after installing the service.';
    public readonly serviceInstalled = 'PgSQL Tools Service installed';
    public readonly serviceInstallationFailed = 'Failed to install PgSQL Tools Service';
    public readonly serviceLoadingFailed = 'Failed to load PgSQL Tools Service';
    public readonly unsupportedPlatformErrorMessage = 'The platform is not supported';
    public readonly invalidServiceFilePath = 'Invalid file path for PgSQL Tools Service';
    ...
    // DEV-NOTE: Update this link once the correct page exists
    public readonly macOpenSslHelpLink = 'https://github.com/Microsoft/carbon/wiki/';
    public readonly serviceName = 'pgSQLToolsService';
    public readonly serviceInitializingOutputChannelName = 'pgSqlToolsService Initialization';

    // DEV-NOTE: Update this link once the correct page exists
    public readonly gettingStartedGuideLink = 'https://github.com/Microsoft/carbon/wiki/Getting-Started';
    public readonly serviceCrashMessage = 'PG SQL Tools Service component could not start.';

    // DEV-NOTE: Update this link once the correct page exists
    public readonly serviceCrashLink = 'https://github.com/Microsoft/carbon/wiki';
