...
export const connectionsArrayName = 'pgsql.connections';
...
export const serviceCompatibleVersion = '0';
...
export const serviceInstallingTo = 'Installing PgSQL tools service to';
...
export const macOpenSslHelpLink = 'https://github.com/Microsoft/carbon/wiki/';

export const pgSqlToolsServiceName = 'pgSQLToolsService';
export const serviceInitializingOutputChannelName = 'pgSqlToolsService Initialization';


// DEV-NOTE: Update this link once the correct page exists
export const gettingStartedGuideLink = 'https://github.com/Microsoft/carbon/wiki/Getting-Started';

export const pgSqlToolsServiceCrashMessage = 'PG SQL Tools Service component could not start.';
export const pgSqlToolsServiceCrashButton = 'View Known Issues';
// DEV-NOTE: Update this link once the correct page exists
export const pgSqlToolsServiceCrashLink = 'https://github.com/Microsoft/carbon/wiki';
