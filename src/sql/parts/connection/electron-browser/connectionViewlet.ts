...
import { IExtensionsWorkbenchService, IExtension, IExtensionsViewlet, VIEWLET_ID, ExtensionState } from 'vs/workbench/parts/extensions/common/extensions';
import {
...
export class ConnectionViewlet extends Viewlet implements IExtensionsViewlet {
	...
	create(parent: Builder): TPromise<void> {
		...
		append(this.root, $<HTMLInputElement>('input.search-box2'));
