...
import 'vs/css!sql/parts/connection/dashboard/server-command-window/server-command-window.component';
...
@AngularCore.Component({
	...
	templateUrl: require.toUrl('sql/parts/connection/dashboard/server-command-window/server-command-window.component.html'),
	styleUrls: [ require.toUrl('sql/parts/connection/dashboard/server-command-window/server-command-window.component.css') ]
})
