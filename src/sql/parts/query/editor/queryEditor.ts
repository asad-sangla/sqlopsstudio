...
export class QueryEditor extends BaseTextEditor {
	...
	constructor(
		...
		super(QueryEditor.ID, telemetryService, instantiationService, contextService, storageService, messageService, configurationService, eventService, editorService, themeService);
...
class NavigateAction extends Action {
	...
	constructor(editor: QueryEditor, next: boolean) {
