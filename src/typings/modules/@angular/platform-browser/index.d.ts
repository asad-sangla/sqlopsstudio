...
// Generated by typings
// Source: node_modules/@angular/platform-browser/src/private_import_core.d.ts
declare module '~@angular/platform-browser/src/private_import_core' {
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
...
export var RenderDebugInfo: typeof r.RenderDebugInfo;
export var ReflectionCapabilities: typeof r.ReflectionCapabilities;
export type DebugDomRootRenderer = typeof r._DebugDomRootRenderer;
export var DebugDomRootRenderer: typeof r.DebugDomRootRenderer;
export var reflector: typeof r.reflector;
export type NoOpAnimationPlayer = typeof r._NoOpAnimationPlayer;
export var NoOpAnimationPlayer: typeof r.NoOpAnimationPlayer;
export type AnimationPlayer = typeof r._AnimationPlayer;
export var AnimationPlayer: typeof r.AnimationPlayer;
export type AnimationSequencePlayer = typeof r._AnimationSequencePlayer;
export var AnimationSequencePlayer: typeof r.AnimationSequencePlayer;
export type AnimationGroupPlayer = typeof r._AnimationGroupPlayer;
export var AnimationGroupPlayer: typeof r.AnimationGroupPlayer;
export type AnimationKeyframe = typeof r._AnimationKeyframe;
export var AnimationKeyframe: typeof r.AnimationKeyframe;
export type AnimationStyles = typeof r._AnimationStyles;
export var AnimationStyles: typeof r.AnimationStyles;
...
export var clearStyles: typeof r.clearStyles;
export var collectAndResolveStyles: typeof r.collectAndResolveStyles;
}
declare module '@angular/platform-browser/src/private_import_core' {
export * from '~@angular/platform-browser/src/private_import_core';
}

// Generated by typings
// Source: node_modules/@angular/platform-browser/src/dom/animation_driver.d.ts
declare module '~@angular/platform-browser/src/dom/animation_driver' {
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
...
import { AnimationKeyframe, AnimationStyles } from '~@angular/platform-browser/src/private_import_core';
/**
 * @experimental
 */
...
declare module '@angular/platform-browser/src/dom/animation_driver' {
export * from '~@angular/platform-browser/src/dom/animation_driver';
}

// Generated by typings
// Source: node_modules/@angular/platform-browser/src/facade/collection.d.ts
...
export function _createConditionalRootRenderer(rootRenderer: any, extraTokens: NgProbeToken[]): any;
/**
...
// Generated by typings
// Source: node_modules/@angular/platform-browser/src/dom/events/hammer_common.d.ts
...
import { AnimationKeyframe, AnimationPlayer, AnimationStyles, RenderDebugInfo } from '~@angular/platform-browser/src/private_import_core';
import { AnimationDriver } from '~@angular/platform-browser/src/dom/animation_driver';
 ...
 * found in the LICENSE file at https://angular.io/license
 */
import * as browser from '~@angular/platform-browser/src/browser';
import * as browserDomAdapter from '~@angular/platform-browser/src/browser/browser_adapter';
import * as location from '~@angular/platform-browser/src/browser/location/browser_platform_location';
import * as testability from '~@angular/platform-browser/src/browser/testability';
import * as ng_probe from '~@angular/platform-browser/src/dom/debug/ng_probe';
...
import * as hammer_gesture from '~@angular/platform-browser/src/dom/events/hammer_gestures';
import * as key_events from '~@angular/platform-browser/src/dom/events/key_events';
...
export { AnimationDriver } from '~@angular/platform-browser/src/dom/animation_driver';
...
// Generated by typings
// Source: node_modules/@angular/platform-browser/index.d.ts
