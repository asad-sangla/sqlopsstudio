...
// Source: node_modules/angular4-grid/directives/NgGrid.d.ts
declare module '~angular4-grid/directives/NgGrid' {
...
import { NgGridConfig, NgGridItemEvent, NgGridItemPosition, NgGridItemSize } from '~angular4-grid/interfaces/INgGrid';
import { NgGridItem } from '~angular4-grid/directives/NgGridItem';
...
declare module 'angular4-grid/directives/NgGrid' {
export * from '~angular4-grid/directives/NgGrid';
}

// Generated by typings
// Source: node_modules/angular4-grid/directives/NgGridItem.d.ts
declare module '~angular4-grid/directives/NgGridItem' {
import { NgGrid } from '~angular4-grid/directives/NgGrid';
import { NgGridItemConfig, NgGridItemEvent, NgGridItemPosition, NgGridItemSize, NgGridRawPosition, NgGridItemDimensions } from '~angular4-grid/interfaces/INgGrid';
...
declare module 'angular4-grid/directives/NgGridItem' {
export * from '~angular4-grid/directives/NgGridItem';
}

// Generated by typings
// Source: node_modules/angular4-grid/components/NgGridPlaceholder.d.ts
declare module '~angular4-grid/components/NgGridPlaceholder' {
import { NgGrid } from '~angular4-grid/directives/NgGrid';
import { NgGridItemPosition, NgGridItemSize } from '~angular4-grid/interfaces/INgGrid';
...
declare module 'angular4-grid/components/NgGridPlaceholder' {
export * from '~angular4-grid/components/NgGridPlaceholder';
}

// Generated by typings
// Source: node_modules/angular4-grid/interfaces/INgGrid.d.ts
declare module '~angular4-grid/interfaces/INgGrid' {
...
declare module 'angular4-grid/interfaces/INgGrid' {
export * from '~angular4-grid/interfaces/INgGrid';
}

// Generated by typings
// Source: node_modules/angular4-grid/modules/NgGrid.module.d.ts
declare module '~angular4-grid/modules/NgGrid.module' {
export class NgGridModule {
}
}
declare module 'angular4-grid/modules/NgGrid.module' {
export * from '~angular4-grid/modules/NgGrid.module';
}

// Generated by typings
// Source: node_modules/angular4-grid/main.d.ts
declare module '~angular4-grid/main' {
export * from '~angular4-grid/directives/NgGrid';
export * from '~angular4-grid/directives/NgGridItem';
export * from '~angular4-grid/components/NgGridPlaceholder';
export * from '~angular4-grid/interfaces/INgGrid';
...
declare module 'angular4-grid/main' {
export * from '~angular4-grid/main';
}
declare module 'angular4-grid' {
export * from '~angular4-grid/main';
}
