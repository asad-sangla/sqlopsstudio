...
Root: HKCR; Subkey: "{#RegValueName}.npmignore\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\.build\electron\{#ExeBasename}.exe"" ""%1"""; Tasks: associatewithfiles
